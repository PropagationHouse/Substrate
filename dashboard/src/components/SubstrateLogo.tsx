...
/** Props for {@link SubstrateLogo}. */
interface SubstrateLogoProps {
  /** Logical size in CSS pixels (canvas is rendered at 2× for retina). @default 28 */
  size?: number;
}

/**
 * Animated canvas logo for the Substrate brand.
 *
 ...
 */
export default function SubstrateLogo({ size = 28 }: SubstrateLogoProps) {
  ...
  return <canvas ref={canvasRef} role="img" aria-label="Substrate logo" style={{ display: 'block' }} />;
}
