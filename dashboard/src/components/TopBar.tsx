...
import SubstrateLogo from "./SubstrateLogo";
...
/**
 * Top navigation bar for the Substrate cockpit.
 *
 * Displays the Substrate logo/brand, and provides toggle buttons for the
