/**
 * LoginPage — Full-screen login gate for Substrate dashboard authentication.
 *
 * Renders a password form matching the dark cockpit theme.
        ...
        <div className="grid lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="px-6 py-8 sm:px-8">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-4">
              <div>
                <label htmlFor="Substrate-password" className="mb-2 block text-[0.733rem] font-medium uppercase tracking-[0.2em] text-muted-foreground">
                  Password
                </label>
                <Input
                  ref={inputRef}
                  id="Substrate-password"
                  type="password"
                  value={password}
              ...
              >
                {submitting ? 'Signing In…' : 'Enter Substrate'}
              </Button>
            </form>
