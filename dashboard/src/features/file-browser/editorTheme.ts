/**
 * CodeMirror theme matching the Substrate dark UI.
 *
...
export const substrateTheme = EditorView.theme(
  {
    '&': {
...
/** Syntax highlighting colors for the Substrate theme. */
export const substrateHighlighting = syntaxHighlighting(
